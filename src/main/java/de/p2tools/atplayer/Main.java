...
public class Main {
    ...
    /*
     * Aufruf: java -jar atplayer [Pfad zur Konfigdatei, sonst homeverzeichnis] [Schalter]
     *
     * Programmschalter:
...
//        }
        ...
        checkMemory(args);
        ATPlayer.main(args);
//        Application.launch(ATPlayer.class, args);
    }

    private void checkMemory(final String[] args) {
        final long maxMem = Runtime.getRuntime().maxMemory();

        // todo muss abgestuft werden -> laden der Audioliste einschränken
