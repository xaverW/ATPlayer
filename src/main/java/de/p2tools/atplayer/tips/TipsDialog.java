...
public class TipsDialog extends P2DialogExtra {
    ...
    private final Button btnAudio = new Button(TipsFactory.TIPPS.AUDIO.getName());
    ...
    private void initButton() {
        ...
        btnAudio.getStyleClass().add("pFuncBtn");
        btnAudio.setOnAction(a -> {
            tips = TipsFactory.TIPPS.AUDIO;
            lblTipsName.setText(tips.getName());
            actTipNo = 0;
            TipData to = tips.getTipsList().get(actTipNo);
            tipBox.setTips(to);
        ...
        gridPane1.add(btnAudio, 0, ++row, 2, 1);
    ...
    private void setSel(Button btn) {
        ...
        btnAudio.getStyleClass().remove("btnTipsDialogSel");
