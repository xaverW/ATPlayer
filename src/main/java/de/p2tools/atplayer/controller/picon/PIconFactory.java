package de.p2tools.atplayer.controller.picon;
...
public class PIconFactory {
    ...
    public enum PICON implements P2IconFactory.P2Icon {
        ...
        TOOLBAR_BTN_DOWNLOAD_START("mdi2d-download-outline", 25),
    ...
    public static void setColor() {
        IkonlyFactory.getAllNodes(ProgData.getInstance().atPlayerController);
    ...
    public static Button getHelpButton(String header, String helpText) {
        return P2Button.helpButton(PICON.BTN_HELP.getFontIcon(), header, helpText);
    }
