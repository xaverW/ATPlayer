...
public class ProgConfig extends P2DataProgConfig {
    ...
    public static DoubleProperty DOWNLOAD_GUI_DIVIDER = addDoubleProp("download-gui-divider", 0.7);
    ...
    public static String SHORTCUT_COPY_AUDIO_THEME_TO_CLIPBOARD_INIT = "Alt+H";
    public static StringProperty SHORTCUT_COPY_AUDIO_THEME_TO_CLIPBOARD = addStrProp("SHORTCUT_COPY_FILM_THEME_TO_CLIPBOARD", SHORTCUT_COPY_AUDIO_THEME_TO_CLIPBOARD_INIT);

    public static String SHORTCUT_COPY_AUDIO_TITLE_TO_CLIPBOARD_INIT = "Alt+T";
    public static StringProperty SHORTCUT_COPY_AUDIO_TITLE_TO_CLIPBOARD = addStrProp("SHORTCUT_COPY_FILM_TITLE_TO_CLIPBOARD", SHORTCUT_COPY_AUDIO_TITLE_TO_CLIPBOARD_INIT);
