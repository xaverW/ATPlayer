...
import de.p2tools.atplayer.controller.config.ProgConfigAskBeforeDelete;
import de.p2tools.atplayer.controller.downloadtools.ATInfoFile;
import de.p2tools.atplayer.gui.dialog.downloadadd.DownloadOnlyStopDialogController;
import de.p2tools.atplayer.gui.dialog.downloadadd.DownloadStopDialogController;
...
//        }
    ...
    private static ObservableList<File> getDownloadFileList(DownloadData downloadData) {
        ...
        if (downloadData.isInfoFile()) {
            Path infoPath = ATInfoFile.getInfoFilePath(downloadData);
            if (infoPath != null) {
