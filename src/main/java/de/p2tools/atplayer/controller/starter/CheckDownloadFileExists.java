...
import de.p2tools.atplayer.gui.dialog.DownloadContinueDialogController;
...
public class CheckDownloadFileExists {
    ...
    public boolean checkIfContinue(ProgData progData, DownloadData download, boolean httpDownload) {
