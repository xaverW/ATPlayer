...
public class HelpText {
    ...
    public static final String FILTER_INFO =
            "Die Menüs, Textfelder und Schieberegler erlauben ein detailliertes " +
                    "Durchsuchen und Filtern der vorhandenen Audios." +
                    "\n" +
                    "\n" +

                    "Mit dem Filter \"Sender\" und \"Genre\" können ein oder " +
                    ...
                    "'Sport,Fussball' (Komma-getrennt) findet Audios bei denen 'Sport' oder 'Fussball' " +
    ...
    public static final String CONFIG_GEO =
            "Nicht alle Audios lassen sich aus allen Ländern abrufen (Geoblocking). Man kann hier " +
                    "seinen Standort angeben, wenn geblockte Audios in der Liste markiert werden sollen.\n" +
                    "\n" +
                    ...
                    "\n" +
                    "ATPlayer kennt aber nicht alle Muster für geogeblockte Sendungen. Ob ein fehlerhafter " +
                    "Download auf Geoblocking zurückzuführen ist, zeigt sich beim Klick auf den Link zur " +
                    "Sendung ('zur Website' ganz unten in der Ansicht 'Audios'). Wenn die Sendung auch auf der " +
    ...
    public static final String LOAD_ONLY_FILMS =
            "\"Nur Audios der letzten Tage laden:\" Die Audioliste enthält nur Audios aus diesem Zeitraum. " +
                    ...
                    "\n" +
                    "\"Nur Audios mit Mindestlänge laden:\" Die Audioliste enthält nur Audios von " +
                    "mindestens dieser Dauer. Audios ohne Längenangabe sind immer enthalten.\n" +
                    "\n" +
                    "Bei 'alles laden' sind alle Audios enthalten.\n" +
                    "\n" +
                    "Auswirkung hat das Filtern erst nach dem " +
                    "Neuladen der Audioliste." +
                    "\n";

    public static final String LOAD_FILMLIST_SENDER =
            "Audios der markierten Sender werden aus der Audioliste ausgeschlossen.\n" +
                    "\n" +
                    "Wirksam erst nach dem Neuladen der kompletten Audioliste." +
                    "\n";

    public static final String LOAD_FILMLIST_PROGRAMSTART =
            "Die Audioliste wird beim Programmstart automatisch geladen, " +
                    "wenn sie älter als " + ProgConst.ALTER_FILMLISTE_TAGE_FUER_AUTOUPDATE + " Tage ist. Sie kann auch über den " +
                    "Menüpunkt \"Eine neue Audioliste laden\" im Programmmenü aktualisiert werden." +
                    "\n";

    public static final String DIAKRITISCHE_ZEICHEN =
            "\"Diakritische Zeichen ändern\" meint, dass bestimmte Zeichen in den " +
                    "Audiofeldern: \"Titel, Thema und Beschreibung\" " +
                    ...
                    "Audioliste. Beim Suchen nach Audios, Downloads und Abos werden die *angepassten " +
                    ...
                    "aber wieder eingeschaltet (also angezeigt) werden, muss dazu eine neue Audioliste geladen werden!" +
                    "\n";
    ...
    public static final String VIDEOPLAYER =
            "Um ein Audio in einem Videoplayer abzuspielen, kann hier ein Player angegeben werden. " +
                    "Empfohlen ist der VLC.\n\n" +
                    "Wird nichts angegeben, wird versucht den Videoplayer des " +
                    "Betriebssystems zu verwenden. Klappt das aber nicht, können die Audios nicht abgespielt " +
                    "werden." +
                    "\n";
    ...
    public static final String PLAY_FILE_HELP_PARAMETER =
            "Hier werden die Parameter zum gewählten Programm eingetragen.\n" +
                    ...
                    "Meist reicht: '%f'\n\n" +
                    "Von ATPlayer kann folgender Parameter genutzt werden:\n" +
                    "\n" +
                    "%f Original-URL des Audios\n" +
                    "\n" +
                    "Beispiel für VLC:\n" +
                    "===============\n" +
                    ...
                    "Parameter: '%f\n" +
                    "\n" +
                    "Hier wird %f durch die URL des Audios ersetzt. Es resultiert:\n" +
    ...
    public static final String PSET_FILE_NAME =
            "Beim Dateinamen sind diese Parameter möglich:\n" +
                    "\n" +
                    "%D   Sendedatum des Audios, wenn leer von 'heute'\n" +
                    "%d   Sendezeit des Audios, wenn leer von 'jetzt'\n" +
                    ...
                    "\n" +
                    "%1   Tag, vom Sendedatum des Audios, wenn leer von 'heute'\n" +
                    "%2   Monat, ebenso\n" +
                    "%3   Jahr, ebenso\n" +
                    "\n" +
                    "%4   Stunde, von der Sendezeit des Audios, wenn leer von 'jetzt'\n" +
                    "%5   Minute, ebenso\n" +
                    "%6   Sekunde, ebenso\n" +
                    "\n" +
                    "%s   Sender des Audios\n" +
                    ...
                    "\n" +
                    "%i   Audionummer (ändert sich beim Neuladen der Audioliste!)\n" +
                    "\n" +
    ...
    public static final String PSET_FILE_HELP_PARAMETER =
            "Hier werden die Parameter zum gewählten Programm eingetragen.\n" +
                    ...
                    "[Parameter:] In diesem Feld werden die Argumente (Schalter, Optionen, etc.) des gewählten " +
                    "Programms angegeben. Sie sollten in dessen Dokumentation zu finden sein.\n" +
                    "Von ATPlayer können folgende Parameter genutzt werden:\n" +
                    "\n" +
                    "%f Original-URL des Audios\n" +
                    ...
                    "Dateiname: '%t-%T.ts'\n" +
                    "\n" +
                    "Hier wird %f durch die URL des Audios ersetzt. %t und %T werden durch Thema und Titel als " +
                    ...
                    "=====================\n" +
                    "Windows:\n" +
                    "Der Pfad wird hier relativ zur Programmdatei von ATPlayer angegeben, weil ATPlayer für " +
