...
public class PaneBlackList {
    ...
    public PaneBlackList(Stage stage, ProgData progData, boolean controlBlackListNotFilmFilter, BooleanProperty blackDataChanged) {
        ...
        panelFilterGrid = new PanelFilterGrid(tableView, list, progData.blackListFilterBlackList);
    }
    ...
    private void addConfigs(VBox vBox) {
        ...
        mbGenre.textProperty().addListener((observable, oldValue, newValue) -> setChanged());
    ...
    private void setActBlackData() {
        ...
        if (blackData != null) {
            ...
            mbGenreProp.unbindBidirectional(blackData.genreProperty());
        ...
        if (blackData != null) {
            ...
            mbGenreProp.bindBidirectional(blackData.genreProperty());
