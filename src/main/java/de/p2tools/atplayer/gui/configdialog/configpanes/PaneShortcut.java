...
public class PaneShortcut {
    ...
    private void setActReplaceData() {
        P2ShortcutKey pShortcutKeyAct = tableView.getSelectionModel().getSelectedItem();
        txtLongDescription.setDisable(pShortcutKeyAct == null);
        if (pShortcutKeyAct != null) {
            txtLongDescription.setText(pShortcutKeyAct.getLongDescription());
        } else {
