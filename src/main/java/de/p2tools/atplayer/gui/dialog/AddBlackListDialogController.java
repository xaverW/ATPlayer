...
public class AddBlackListDialogController extends P2DialogExtra {
    ...
    private final Button btnGenre = new Button();
    ...
    private final Button btnClearGenre = new Button();
    ...
    private final String genre; // sind die Startwerte
    ...
    private void initButton() {
        ...
        btnOk.disableProperty().bind(blackData.channelProperty().isEmpty()
                .and(blackData.genreProperty().isEmpty()
                        .and(blackData.themeProperty().isEmpty()
                                .and(blackData.titleProperty().isEmpty()
                                        .and(blackData.themeTitleProperty().isEmpty())
                                ))));
    ...
    private void initGridPane() {
        ...
        gridPane.add(mbGenre, 1, row);
        gridPane.add(btnGenre, 2, row);
        gridPane.add(btnClearGenre, 3, row);
