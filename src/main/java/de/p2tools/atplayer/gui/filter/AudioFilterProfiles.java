...
public class AudioFilterProfiles extends VBox {
    ...
    public AudioFilterProfiles() {
        ...
        PListener.addListener(new PListener(PListener.EVENT_FILTER_CHANGED, AudioFilterProfiles.class.getSimpleName()) {
            @Override
            public void pingFx() {
                checkCboFilter();
            }
    ...
    private void filterProfiles() {
        ...
        cboFilterProfiles.setItems(progData.filterWorker.getFilterList());
        ...
        ProgConfig.FILTER_SEL_FILTER.bind(cboFilterProfiles.getSelectionModel().selectedIndexProperty());
    ...
    private void resetFilter() {
        if (P2Alert.showAlertOkCancel("Zurücksetzen", "Filterprofile zurücksetzen",
                "Sollen alle Filterprofile gelöscht " +
                        ...
                        "ersetzt werden?")) {
            progData.filterWorker.getFilterList().clear();
    ...
    private void checkCboFilter() {
        AudioFilter sf = progData.filterWorker.getActFilterSettings();
