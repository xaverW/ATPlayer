...
public class AudioFilterSortDialog extends P2DialogExtra {
    ...
    public void make() {
        ...
        btnTop.setOnAction(event -> {
            ...
            if (sel < 0) {
                ...
                int res = progData.filterWorker.getFilterList().top(sel, true);
        ...
        btnBottom.setOnAction(event -> {
            ...
            if (sel < 0) {
                ...
                int res = progData.filterWorker.getFilterList().top(sel, false);
                tableView.getSelectionModel().select(res);
            }
        });
        ...
        btnUp.setOnAction(event -> {
            ...
            if (sel < 0) {
                ...
                int res = progData.filterWorker.getFilterList().up(sel, true);
                tableView.getSelectionModel().select(res);
            }
        });
        ...
        btnDown.setOnAction(event -> {
            ...
            if (sel < 0) {
                ...
                int res = progData.filterWorker.getFilterList().up(sel, false);
                tableView.getSelectionModel().select(res);
            }
        });
    }
    ...
    private void addSeparator() {
        final int sel = tableView.getSelectionModel().getSelectedIndex();
        AudioFilter sf = new AudioFilter(P2CboSeparator.SEPARATOR);
        if (sel < 0) {
