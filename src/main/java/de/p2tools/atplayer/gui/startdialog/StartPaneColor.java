...
public class StartPaneColor extends VBox {
    ...
    public StartPaneColor(Stage stage) {
    }
    ...
    private void makeImage() {
        ...
        String path = "/de/p2tools/atplayer/res/startdialog/gui_light_1.png";
        ...
        path = "/de/p2tools/atplayer/res/startdialog/gui_light_2.png";
        ...
        path = "/de/p2tools/atplayer/res/startdialog/gui_dark_1.png";
        image = new Image(path, size, size, true, true);
        ...
        path = "/de/p2tools/atplayer/res/startdialog/gui_dark_2.png";
        image = new Image(path, size, size, true, true);
